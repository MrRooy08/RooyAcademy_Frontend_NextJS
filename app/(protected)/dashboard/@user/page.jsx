...
import { useGetEnrolledCoursesQuery } from "@/app/features/courses/courseApi"
...
export default function UserCoursesPage() {
  ...
  const {data, isLoading, isFetching, isError, refetch} = useGetEnrolledCoursesQuery();
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-gray-600 mt-1">Xem các khoá học đã tham gia</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Còn học</CardTitle>
            </CardHeader>
            <CardContent>
