          ...
          <div className="md:col-span-1">
            <Card className="animate-fadeIn hover-lift">
              <CardContent className="pt-6 flex flex-col items-center">
                ...
                <p className="text-gray-500 text-center">{user?.result?.position}</p>

                <div className="w-full mt-6 space-y-3">
                  <div className="flex items-center">
                    <Mail className="h-8 w-7 text-gray-400 mr-3" />
                    <span className="text-lg">{user?.result?.email}</span>
                  </div>
                  <div className="flex items-center">
                    <Phone className="h-8 w-7 text-gray-400 mr-3" />
                    <span className="text-lg">{user?.result?.phone}</span>
                  </div>
                  <div className="flex items-center">
                    <MapPin className="h-8 w-7 text-gray-400 mr-3" />
                    <span className="text-lg">{user?.result?.location}</span>
                  </div>
                  <div className="flex items-center">
                    <Briefcase className="h-8 w-7 text-gray-400 mr-3" />
                    <span className="text-lg">{user?.result?.company}</span>
                  </div>
                  <div className="flex items-center">
                    <Calendar className="h-8 w-7 text-gray-400 mr-3" />
                    <span className="text-lg">Joined {user?.result?.joined}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  <CardContent className="space-y-4">
                    {isEditing ? (
                      ...
                      <div className="space-y-4">
                        <p className="text-gray-700 text-lg">{user?.result?.bio}</p>
